...
- iCloud Keychain: keep protocol tests synthetic and network-free.
  ...
  Citrus must install no backend, relay, CLI, or native-messaging manifest for this
  feature, and no Apple account state may be created there. Do not introduce KDBX.
